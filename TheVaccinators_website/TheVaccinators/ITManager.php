...
<h1 style="font-family:courier;"letter-spacing><center>Welcome Elie Dani Jedaan</center></h1> 


<p style="font-family:courier;"letter-spacing><center> <b>IT info</center></b></p>
</body>
<head>
<style>
table, th, td {
...
<?php
  $conn=mysqli_connect("localhost","ElieDaniJedaan","Elie5362","Vaccinationcenter");
...
$sql = "SELECT * FROM ITemployees";
$result = $conn->query($sql);

if ($result->num_rows > 0) {
    echo "<table><tr><th>ID</th><th>Name</th><th>Gender</th><th>Date of birth</th><th>Street</th><th>Department Name</th><th>Salary per hour</th><th>Number of hours</th></tr>";
